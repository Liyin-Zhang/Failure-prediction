...
from torch_geometric.nn import GCNConv, GATConv, SAGEConv,global_mean_pool, BatchNorm,GINConv,TransformerConv
...
class Discriminator(nn.Module):
    def __init__(self, in_dim, hidden_dim):
        ...
        self.conv1 = TransformerConv(in_dim*2, hidden_dim, heads=1, dropout=0.0)  # 第一层 GCN
